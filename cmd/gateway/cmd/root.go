...
import (
	...
	app "github.com/andreyAKor/otus_arch_project/internal/app/gateway"
	configs "github.com/andreyAKor/otus_arch_project/internal/configs/gateway"
...
var rootCmd = &cobra.Command{
	Use:   "gateway",
	Short: "Gateway API service application",
	Long:  "The Gateway API service is gateway service for representation inner rpc to restful rpc",
	RunE:  run,
}
...
func run(cmd *cobra.Command, args []string) error {
	...
	// Init and run app
	a, err := app.New(microService, c.HTTP.Host, c.HTTP.Port, c.HTTP.BodyLimit)
	if err != nil {
